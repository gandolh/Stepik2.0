...
using Licenta.Sdk.Identity.AccessTokenManagement.ClientAccessToken;
using Licenta.Sdk.Identity.AccessTokenManagement.UserAccessToken;

namespace Licenta.Sdk.Identity.AccessTokenManagement.Interfaces
{
    /// <summary>
